...
Test Plus Numbers 8 and 4
    ...
    Should Be Equal As Integers    ${json_resp['result']}    12

Test Plus Numbers 4 and 2
    ${json_resp}=    Get Calculation JSON    4    2
    Should Be Equal As Integers    ${json_resp['result']}    6

Test Plus Numbers 8.4 and 4
    ${json_resp}=    Get Calculation JSON    8.4    4
    Should Be Equal As Integers    ${json_resp['result']}    12.4
...
Test Plus Numbers -4 and 2
    ${json_resp}=    Get Calculation JSON    -4    2
    Should Be Equal As Integers    ${json_resp['result']}    -2
